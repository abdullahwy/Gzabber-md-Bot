...
var NEED = ''
if (Config.LANG == 'EN') NEED = '*ℹ️Please give a valid spotify link.*'
if (Config.LANG == 'SI') NEED = '*ℹ️කරුණාකර වලංගු spotify සබැදියක් ඇතුළත් කරන්න.ℹ️*'
...
var n_song = ''
if (Config.LANG == 'EN') nsong = '*ℹ️Please type the song name after the command.*'
if (Config.LANG == 'SI') nsong = '*ℹ️කරුණාකර විධානයට පසුව ගීතයේ නම ටයිප් කරන්න.*'
