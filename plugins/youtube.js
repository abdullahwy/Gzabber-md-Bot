...
Aqua.addCommand({pattern: 'asong ?(.*)', fromMe: wk, dontAddCommandList: true, deleteCommand: false}, (async (message, match) => { 
 ...
 Aqua.addCommand({pattern: 'video ?(.*)', fromMe: wk, desc: Lang.VIDEO_DESC, deleteCommand: false }, (async (message, match) => {
   ...
   const buttons = [
        {buttonId: HANDLE + 'vid720' + s2vid , buttonText: {displayText: '720P Quality' }, type: 1},
        {buttonId: HANDLE + 'vid480' + s2vid , buttonText: {displayText: '480P Quality' }, type: 1},
        {buttonId: HANDLE + 'vid360' + s2vid , buttonText: {displayText: '360P quality' }, type: 1}
